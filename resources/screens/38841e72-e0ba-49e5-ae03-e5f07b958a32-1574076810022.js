jQuery("#simulation")
  .on("click", ".s-38841e72-e0ba-49e5-ae03-e5f07b958a32 .click", function(event, data) {
  ...
  .on("pageload", ".s-38841e72-e0ba-49e5-ae03-e5f07b958a32 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
