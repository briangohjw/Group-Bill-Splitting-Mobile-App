jQuery("#simulation")
  .on("click", ".s-3d560776-f226-4982-bd43-1e1e9d4b6071 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/38841e72-e0ba-49e5-ae03-e5f07b958a32",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-3d560776-f226-4982-bd43-1e1e9d4b6071 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
